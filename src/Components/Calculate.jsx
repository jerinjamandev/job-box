...
const Calculate = () => {
  ...
  <div
    ...
    <div
      className="flex flex-col justify-center items-center  px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        ...
        <svg className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 51 50" fill="none"
          ...
          <g clipPath="url(#a)">
            <path
              ...
              stroke="#FF6D42" strokeWidth="4.341" strokeLinecap="round" strokeLinejoin="round"></path>
          </g>
          <defs>
            <clipPath id="a">
    ...
    <div
      ...
      <div className="flex flex-row justify-center items-center">
        <svg className="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 50 50" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#a)" stroke="#FF6D42" strokeWidth="3.473" strokeLinecap="round" strokeLinejoin="round">
            <path
